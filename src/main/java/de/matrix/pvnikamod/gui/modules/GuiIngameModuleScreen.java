...
public abstract class GuiIngameModuleScreen extends GuiScreen {
    ...
    public void initGui(int i, int j, int k, int w){
        ...
        buttonList.add(this.sliderX = new ModulePosSlider(this.aModule, 201, width / 2 - (w/2), height / 4 + 1 * j + i, w, 20, I18n.format("menu.pvnika.all.posx") + ": ", "", 0, this.mc.displayWidth, CustomRenderManager.translateXFromConfig(this.aModule.posX), false, true));
        ...
        buttonList.add(this.sliderY = new ModulePosSlider(this.aModule, 202, width / 2 - (w/2), height / 4 + 2 * j + i, w, 20, I18n.format("menu.pvnika.all.posy") + ": ", "", 0, this.mc.displayHeight, CustomRenderManager.translateYFromConfig(this.aModule.posY), false, true));
    ...
    public void refreshButtons(){
        ...
        this.sliderX.setValue(CustomRenderManager.translateXFromConfig(this.aModule.posX));
        this.sliderY.setValue(CustomRenderManager.translateYFromConfig(this.aModule.posY));
    }
    ...
    public void actionPerformed(GuiButton button) throws IOException{
        ...
        int slX = CustomRenderManager.translateXFromConfig(this.aModule.posX);
        int slY = CustomRenderManager.translateYFromConfig(this.aModule.posY);
        ...
        this.aModule.posX = CustomRenderManager.translateXToConfig(this.sliderX.getValueInt());
        this.aModule.posY = CustomRenderManager.translateYToConfig(this.sliderY.getValueInt());
